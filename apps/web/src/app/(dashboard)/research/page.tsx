        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-white rounded-xl border border-slate-200 p-6 animate-pulse">
              ...
              <div className="h-6 bg-slate-200 rounded-full w-20 mb-3" />
          ...
          {briefs.map((brief) => (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <h3 className="font-semibold text-slate-900 text-sm leading-snug pr-2 flex-1">
                  {brief.title}
                </h3>
              </div>
              <p className="text-xs text-slate-500 mb-3">{brief.matterName}</p>
              <div className="mb-3">
