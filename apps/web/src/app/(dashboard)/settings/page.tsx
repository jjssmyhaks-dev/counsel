...
export default function SettingsPage() {
 ...
 <div className="h-8 bg-black/[0.04] rounded w-48 animate-pulse mb-2" />
 <div className="h-4 bg-black/[0.03] rounded w-64 animate-pulse" />
 </div>
 <div className="bg-white dark:bg-slate-900 rounded-xl border border-black/[0.04] dark:border-white/[0.06] p-6 animate-pulse">
 <div className="h-6 bg-black/[0.04] rounded w-1/3 mb-4" />
 <div className="space-y-3">
 <div className="h-10 bg-black/[0.03] rounded" />
 <div className="h-10 bg-black/[0.03] rounded" />
 </div>
 </div>
 </div>
 ...
 <h3 className="text-lg font-semibold text-[#0c0a09] dark:text-white">Firm Profile</h3>
 {!editing ? (
 ...
 <p className="text-sm text-[#0c0a09] dark:text-white font-medium">{firmName}</p>
 )}
 </div>
 ...
 />
 <div className="w-9 h-5 bg-black/[0.04] peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white dark:bg-slate-900 after:border-black/[0.08] dark:border-slate-700 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[#0c0a09]"></div>
 </label>
 </div>
 ))}
 </div>
 ...
 <div>
 <label className="block text-xs font-medium text-[#c2452e] mb-1">
