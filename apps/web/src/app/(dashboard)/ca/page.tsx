...
export default function CADashboardPage() {
  ...
  if (loading) {
    return (
      <div className="p-6 space-y-6 animate-pulse">
        <div className="h-8 w-64 skeleton-bg rounded" />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[1,2,3,4].map(i => <div key={i} className="h-24 skeleton-bg rounded-lg" />)}
        </div>
        <div className="h-64 skeleton-bg rounded-lg" />
      </div>
    );
  }
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      {/* Two-column: Activities + Integrations */}
