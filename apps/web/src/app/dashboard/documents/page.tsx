...
export default function DocumentsPage() {
 ...
 {/* Loading */}
 {loading && (
 <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-black/[0.04] dark:border-white/[0.06] overflow-hidden">
 ...
 className="text-xs text-red-500 hover:text-[#f0705b] font-medium"
 >
 Delete
 </button>
 </div>
