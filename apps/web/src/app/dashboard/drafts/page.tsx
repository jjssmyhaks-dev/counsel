...
export default function DraftsPage() {
 ...
 <div className="h-5 bg-black/[0.04] rounded w-1/3" />
 <div className="h-5 bg-black/[0.04] rounded-full w-16" />
 <div className="h-5 bg-black/[0.04] rounded-full w-20" />
 <div className="h-5 bg-black/[0.03] rounded w-1/4" />
 <div className="h-5 bg-black/[0.03] rounded w-20 ml-auto" />
 </div>
 ))}
 </div>
 </div>
