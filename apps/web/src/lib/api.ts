...
const MOCK_DOCUMENTS: Document[] = [
  {
    id: 'doc-001',
    originalName: 'Quantum Dynamics - Merger Agreement v3.pdf',
    filename: 'Quantum Dynamics - Merger Agreement v3.pdf',
  ...
  {
    id: 'doc-002',
    originalName: 'Evergreen - Patent Filing US2026-001234.pdf',
    filename: 'Evergreen - Patent Filing US2026-001234.pdf',
    mimeType: 'application/pdf',
    sizeBytes: 1800000,
    status: 'PROCESSING',
    matterId: 'matter-002',
  ...
  {
    id: 'doc-003',
    originalName: 'Brighton - Lease Agreement 2024.docx',
    filename: 'Brighton - Lease Agreement 2024.docx',
  ...
  {
    id: 'doc-004',
    originalName: 'NovaTech - Data Processing Agreement.pdf',
    filename: 'NovaTech - Data Processing Agreement.pdf',
    mimeType: 'application/pdf',
    sizeBytes: 3200000,
    status: 'READY',
    matterId: 'matter-005',
  ...
  {
    id: 'doc-005',
    originalName: 'Thompson - Settlement Agreement Draft.pdf',
    filename: 'Thompson - Settlement Agreement Draft.pdf',
    mimeType: 'application/pdf',
    sizeBytes: 1500000,
    status: 'UPLOADED',
    matterId: 'matter-004',
  ...
  {
    id: 'doc-006',
    originalName: 'Quantum - Regulatory Filing SEC.pdf',
    filename: 'Quantum - Regulatory Filing SEC.pdf',
    mimeType: 'application/pdf',
    sizeBytes: 4100000,
    status: 'FAILED',
    matterId: 'matter-001',
...
const MOCK_DRAFTS: Draft[] = [
  ...
  },
  {
    ...
    matterId: 'matter-003',
    matterName: 'Brighton Condominium Dispute',
    createdBy: 'user-001',
  ...
  },
  {
    ...
    matterId: 'matter-005',
    matterName: 'Brighton Commercial Dispute',
    createdBy: 'user-001',
...
function getMockResponse<T>(path: string, body?: unknown): T | undefined {
  ...
  if (path === '/agents/proposal') return mockGetDrafts() as unknown as T;
  if (path === '/agents/market-intel') return mockGetResearch() as unknown as T;
